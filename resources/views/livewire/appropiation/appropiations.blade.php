<div class="row sales layout-top-spacing">
            ...
            <div class="widget-heading">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        @endcan
                        <div class="col-sm-3">
                            <a href="{{ url('appropiation_report/pdf' . '/' . $my_total . '/' . $search) }}" class="btn btn-dark btn-md" target="_blank">
                                Generar PDF
                            </a>
                        </div>
                        {{--<div class="col-sm-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @can('editar_registro')
                                    <a href="javascript:void(0)" wire:click.prevent="Edit({{$appropiation->id}})" class="btn btn-dark mtmobile" title="Editar" data-toggle="modal" data-target="#theModal2">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    @endcan
                                    @can('eliminar_registro')
                                    <a href="javascript:void(0)" onclick="Confirm('{{$appropiation->id}}')" class="btn btn-dark" title="Eliminar">
    ...
    @include('livewire.appropiation.form')
    @include('livewire.appropiation.form2')
    @include('livewire.appropiation.detail')
    @include('livewire.other_provider.data_import')
</div>
